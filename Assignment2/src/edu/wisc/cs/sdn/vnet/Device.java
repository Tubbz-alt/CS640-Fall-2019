...
public abstract class Device {
	...
	/**
	 * PCAP dump file for logging all packets sent/received by the device; null if
	 * packets should not be logged
	 */
	 ...
	 * @param logfile PCAP dump file for logging all packets sent/received by the
	 *                device
	 */
	...
	/**
	 * @return PCAP dump file for logging all packets sent/received by the device;
	...
	/**
	 * @return list of the router's interfaces; maps interface name's to interfaces
	 */
	 ...
	 * @return requested interface; null if no interface with the given name exists
	 */
	 ...
	 * 
	 * @param etherPacket an Ethernet packet with all fields, encapsulated headers,
	 *                    and payloads completed
